...
LangString appRunning ${LANG_ENGLISH} "${PRODUCTNAME} is running or minimized to the system tray. Please exit it from the tray menu first, then try again."
LangString appRunningOkKill ${LANG_ENGLISH} "${PRODUCTNAME} is running or minimized to the system tray.$\nClick OK to close it automatically."
...
LangString failedToKillApp ${LANG_ENGLISH} "Failed to close ${PRODUCTNAME}. If it is minimized to the system tray, please exit it from the tray menu manually, then try again."
